...
{
  "PK": "SLOT#2026-08",
  "SK": "SLOT#2026-08-04T10:30",
  "slotId": "2026-08-04T10:30",
  "date": "2026-08-04",          // JST
  "startTime": "10:30",
  "endTime": "11:30",            // 60分 (40分リトミック + 20分相談会)
  "capacity": 15,                // 定員 15名
...
UI上は、枠に対して「**3歳まで推奨 / 4歳以上推奨**」の目安ラベルを
表示できるようにしておく（`ageHint` 属性を任意で持たせる）。
